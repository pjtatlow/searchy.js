...
var post=settings.posts[id];$(".searchy-results-preview").empty();$(".searchy-results-preview").append('<h5 class="text-center"><strong>Preview</strong></h5><div class="searchy-preview-container"></div>');$(".searchy-preview-container").append(post.html);if(settings.dates){$(".searchy-results-preview").append('<h5 class="searchy-results-preview-meta">'+post.date.toLocaleDateString()+"</h5>");}
$('.searchy-input').focus();}
...
window.location=href;}}});$(".searchy-background").on("click",function(e){if(e.target==$(this)[0]){$(this).fadeToggle(100,function(){$("#searchy-input").blur();});}});$(".searchy-input-cover").on("click",function(e){$(".searchy-input").focus();});$(".searchy-input").on("input",function(e){$(".searchy-bottom").empty();var results=settings.idx.search($(this).val());if(results.length>0){$(".searchy-bottom").empty();$(".searchy-bottom").append('<div class="searchy-results"><div><h5 class="searchy-results-title"><strong>Results:</strong><span class="pull-right>"'+results.length+'</span></h5></div></div><div class="searchy-results-preview"></div>')
